 ...
 * There are K identical assignees available and we are also given how much time an
 * assignee takes to do one unit of the job. Find the minimum time to finish all jobs with following constraints
 * https://www.geeksforgeeks.org/find-minimum-time-to-finish-all-jobs-with-given-constraints/
 * @author gsinha
 * 18 aug 2022
 */
public class FinishAllJobs {
